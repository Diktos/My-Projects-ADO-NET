...
// Коли потрібно виконати асинхронну операцію, наприклад: читання/запис файлів, запити до бази даних, HTTP-запити(фонові операції).
...
// Не у фоні може виконуватися, як таск. Коли потрібен окремий потік - який не закриється сам по собі.
// Довготривале виконання чогось (щоб не повибивати трід пул на нівець)
